...
export const ContactView: FC = ({setOpenContact}) => {
  ...
  const CloseModal = () => {
    <a onClick={() => setOpenContact(false)} className='group mt-4 inline-flex h-10 w-10 items-center justify-center rounded-lg bg-white/20 backdrop-blur-2xl transition-all duration-500 hover:bg-blue-500/60'>
                  ...
                  <div className="text-start">
                    <form onSubmit={handleSubmit}>
                      <div className="mb-4">
                        ...
                        Email</label>
                        <input type="email" id='email' name='email' className='border-default-200 block w-full rounded
                        border-white/10 bg -transparent py-1.5 px-3 text-white/80 focus:border-white/25 focus:ring-transparent' placeholder='email' />
                      </div>
